...
class Config:
    ...
    # Database
    SQLALCHEMY_DATABASE_URI = os.getenv('DATABASE_URL', 'sqlite:///ott_tracker.db')
    ...
    if not TMDB_API_KEY:
        print("WARNING: TMDB_API_KEY is not set. Movie data fetching will fail.", file=sys.stderr)
